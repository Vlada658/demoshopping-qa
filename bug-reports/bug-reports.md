...
<details>
<summary>🐞 БАГ 1 — Названия полей отображаются на английском языке в форме «Вход»</summary>
...
<details>
<summary>🐞 БАГ 3 — При вводе неправильного пароля отображается некорректное сообщение в форме авторизации</summary>
...
<details>
<summary>🐞 БАГ 4 — Кнопка «Зарегистрироваться» не заменяется на «Выйти» после успешной регистрации</summary>
...
<details>
<summary>🐞 БАГ 5 — Редирект выполняется некорректно при переходе по ссылке авторизации</summary>
...
<details>
<summary>🐞 БАГ 6 — Изображения товаров не загружаются при переходе на следующую страницу каталога</summary>
...
<details>
<summary>🐞 БАГ 8 — Валюта товара отображается некорректно в корзине после добавления товара</summary>
...
<details>
<summary>🐞 БАГ 9 — Товары отсутствуют в корзине после возврата со страницы оплаты</summary>
...
<details>
<summary>🐞 БАГ 10 — Сортировка по цене при выборе «Цена по убыванию» отображает товары по возрастанию в каталоге товаров</summary>
...
<details>
<summary>🐞 БАГ 11 — Сортировка по цене при выборе «Цена по возрастанию» отображает товары по убыванию в каталоге товаров</summary>
...
<details>
<summary>🐞 БАГ 12 — Оплата проходит успешно при выборе неверного типа карты на странице оплаты</summary>
